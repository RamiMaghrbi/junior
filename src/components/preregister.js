            ...
            <div className="mx-auto px-4 w-full flex flex-col gap-10">
                ...
                <div className="flex flex-col sm:flex-row gap-10 ">
                    <div style={{ position: 'fixed', maxHeight: '100%' }}>
                        ...
                        <Card className={`flex-1 table-auto h-full w-full mt-6 mr-4 overflow-auto ${selectedSubjects.length > 4 ? 'table-scroll' : ''}`}>
                                        ...
                                        <tr key={index} className={index % 2 === 0 ? 'bg-white' : 'bg-gradient-to-r from-gray-200 to-blue-300'}>
                                            <td className="p-5 border-b border-blue-gray-50">
                                                <button
                                                    ...
                                                    style={{ padding: '0' }}
                                                >
                                                    <MdDeleteSweep style={{ fontSize: '20px', color: 'white' }} />
                                                </button>
                                            </td>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6" style={{ marginRight: '30%' }}>
                        {filteredData.map((item, index) => (
                            <Card key={index} className="rounded bg-white w-full px-19">
                                ...
                                <CardFooter className="pt-5 pb-5">
                                    <Button onClick={() => addToCart(item.subject)} className="rounded bg-gradient-to-r from-gray-600 to-blue-700  text-white px-20">Select Subject</Button>
                                </CardFooter>
                            </Card>
                        ))}
                    </div>
